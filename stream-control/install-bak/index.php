...
function check_($check) {
    ...
    // Siempre devuelve éxito sin verificar la licencia
          ...
          <div class="wo_install_wiz">
            <div>
                  ...
                  <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <input type="hidden" class="form-control" name="purshase_code" value="LICENCIA-ELIMINADA-POR-USUARIO" placeholder="Purchase code" autofocus>
