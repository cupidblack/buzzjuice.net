        ...
        <div class="navigation">
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    <?php } ?>
                    <?php if ($is_admin || ($is_moderoter && ($wo['user']['permission']['pro-settings'] == 1 || $wo['user']['permission']['pro-members'] == 1 || $wo['user']['permission']['pro-payments'] == 1 || $wo['user']['permission']['pro-features'] == 1 || $wo['user']['permission']['pro-refund'] == 1))) { ?>
                        <li <?php echo ($page == 'pro-settings' || $page == 'pro-members' || $page == 'pro-payments' || $page == 'pro-features' || $page == 'pro-refund') ? 'class="open"' : ''; ?>>
                            <a href="#">
                                <span class="nav-link-icon">
                            ...
                            <ul class="ml-menu">
                                ...
                                <?php } ?>
                                <?php if ($is_admin || ($is_moderoter && $wo['user']['permission']['pro-members'] == 1)) { ?>
                                <li>
                                    <a <?php echo ($page == 'pro-members') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('pro-members'); ?>" data-ajax="?path=pro-members">Manage Members</a>
                                </li>
                                <?php } ?>
