<?php 
// require_once __DIR__ . '/../assets/wo_wp_messages_bridge.php';
...
//require_once __DIR__ . '/../assets/wo_wp_messages_bridge.php';
// --- SYNC TRIGGER START ---
//$from_ww = $value['message']['user_id'];
//$to_ww   = $value['message']['conversation_user_id'];
//if (function_exists('ww_wp_sync_messages')) {
//    ww_wp_sync_messages($from_ww, $to_ww);
//}
// --- SYNC TRIGGER END ---
