...
//$last_url = isset($_GET['last_url']) ? $_GET['last_url'] : '';
//$wo["WordpressLoginUrl"] = $config["site_url"] . "/login-session-bridge.php" . (!empty($last_url) ? "?last_url=" . urlencode($last_url) : "");
$wo["WordpressLoginUrl"] = $config["site_url"] . "/ww-sso-bridge.php";
