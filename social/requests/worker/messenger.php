            ...
            if( count( $conversations ) > 0 ){
                foreach ($conversations as $key => $conversation) {
                    if( $conversation->user->online == 1 ){
                        ...
                        $conversations_html .= '<div class="m_con_item ' . ( ( $conversation->user->online == 1 || $conversation->seen == 0 ) ? 'active' : '' ) .'"><div class="m_c_item_avatar"><img src="'.$conversation->user->avatar.'" alt="'.$conversation->user->full_name.'" title="'.$conversation->user->full_name.'">';
