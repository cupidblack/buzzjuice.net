        ...
        <div class="col m8">
			<div class="center">
				<div class="qd_rstroy_thumbs">
                    <div class="avatar">
						<img src="<?php echo $data['story']['user1Data']->avatar->avatar;?>" alt="<?php echo $data['story']['user1Data']->full_name;?>" />
                    </div>
				...
				<div class="qd_rstroy_thumbs">
                    <div class="avatar">
						<img src="<?php echo $data['story']['user2Data']->avatar->avatar;?>" alt="<?php echo $data['story']['user2Data']->full_name;?>" />
                    </div>
