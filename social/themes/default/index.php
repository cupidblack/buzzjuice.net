                                ...
                                <div class="center">
                                    ...
                                    foreach ($siteUsers as $key => $user){ ?>
                                        <a href="<?php echo $site_url;?>/@<?php echo $user->username;?>" data-ajax="/@<?php echo $user->username;?>">
                                            <img src="<?php echo $user->avatar->avatar;?>" alt="<?php echo $user->full_name;?>" class="circle xuser">
                                        </a>
                                    <?php } ?>
                                </div>
                            </div>
                                ...
                                <div class="carousel-item valign-wrapper" href="#one!">
                                    <div class="dt_testimonial_slide">
                                        <div class="slide_head">
                                            ...
                                            <img src="<?php echo $story['user2Data']->avatar->avatar;?>" alt="<?php echo $story['user2Data']->full_name;?>" class="circle story2" />
