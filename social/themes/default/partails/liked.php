    ...
    <div class="card center">
        <div class="card-image">
            <a href="<?php echo $site_url;?>/@<?php echo $row->username?>" data-ajax="/@<?php echo $row->username?>">
                <img src="<?php echo GetMedia('',false); ?><?php echo $row->avatar?>" alt="<?php echo $row->username?>">
        ...
        <div class="card-content">
            ...
            <p>
                ...
                <?php
                echo (isset(Dataset::load('countries')[$row->country]) ) ? Dataset::load('countries')[$row->country]['name'] : $row->country;
                ?>
            </p>
            <div class="rand_bottom_bar">
                <?php if( (int)$row->id !== (int)auth()->id ){ ?>
                <button id="like_btn" class="btn waves-effect like" data-ajax-post="/useractions/remove_like" data-ajax-params="userid=<?php echo $row->id?>" data-ajax-callback="callback_liked_remove_like">
