	...
	<ul class="home_usr_sct">
		<li>
            <div class="user_popularity_icn" data-value="<?php echo GetUserPopularity($profile->id,true);?>">
                ...
                <a class="avatar" href="<?php echo $site_url;?>/@<?php echo $profile->username;?>" data-ajax="/@<?php echo $profile->username;?>"><img src="<?php echo $profile->avatar->avatar;?>" class="circle" alt="<?php echo $profile->full_name;?>" /></a>
            </div>
			<span>
					...
					?>
						<div class="pro_usr">
							<a href="<?php echo $site_url;?>/@<?php echo $pro_user->username;?>" data-ajax="/@<?php echo $pro_user->username;?>" tooltip="<?php echo $pro_user->username;?>" flow="down">
								<img src="<?php echo GetMedia( $pro_user->avatar );?>" alt="<?php echo $pro_user->username;?>" />
							</a>
						</div>
					<?php } } ?>
				</div>
