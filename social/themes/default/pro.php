				...
				<div class="row dt_prem_row">
					<div class="col s12 m7 l5">
						<div class="dt_choose_pro">
							...
							<p>
								<label>
									<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( '2 Week' );?>" data-price="<?php echo (float)$config->weekly_pro_plan;?>"/>
									<span class="pln_name">
										<span class="duration"><?php echo __( '2 Week' );?></span>
