    ...
    <div class="card">
        <div class="qd_story_card_usr_imgs">
            <a href="<?php echo $site_url;?>/story/<?php echo $story->id. '_'. url_slug($story->quote);?>" data-ajax="/story/<?php echo $story->id. '_'. url_slug($story->quote);?>">
                <img src="<?php echo $story->user->avatar->avatar;?>" alt="<?php echo $story->user->username;?>">
            </a>
            <a href="<?php echo $site_url;?>/story/<?php echo $story->id. '_'. url_slug($story->quote);?>" data-ajax="/story/<?php echo $story->id. '_'. url_slug($story->quote);?>">
                <img src="<?php echo $story->story_user->avatar->avatar;?>" alt="<?php echo $story->story_user->username;?>">
            </a>
