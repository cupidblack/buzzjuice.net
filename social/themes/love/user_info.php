	...
	<body>
		...
		<div class="container">
			<?php if (!empty($user_info['setting'])) { ?>
				...
				<?php } ?>
				<?php if (!empty($user_info['setting']->avatar)) { ?>
					<div class="main_avatar"><img src="<?php echo($user_info['setting']->avatar->avatar) ?>"></div>
				<?php } ?>
						...
						<?php foreach ($user_info['setting']->block as $member) { ?>
							<div class="profile-style" id="member-<?php echo $member->id ?>">
								<a href="<?php echo $site_url.'/@'.$member->username;?>">
									<div class="avatar">
										<img src="<?php echo $member->avatar->avatar;?>" alt="<?php echo $member->full_name; ?> Profile Picture" />
									</div>
								</a>
						...
						<?php foreach ($user_info['all_friends'] as $key => $friend) { ?>
							<div class="profile-style" data-user-id="<?php echo $friend->id;?>">
								<a href="<?php echo $site_url.'/@'.$friend->username;?>" >
									<div class="avatar">
										<img src="<?php echo GetMedia($friend->avatar);?>" alt="Profile Picture" />
									</div>
								</a>
					...
					<div class="users_list">
						<?php foreach ($user_info['mediafiles'] as $key => $media) { ?>
							<div class="profile-style">
								...
								<?php }else{ ?>
									<a href="<?php echo $media['avatar'];?>" >
										<div class="avatar">
											<img src="<?php echo $media['avatar'];?>"/>
										</div>
									</a>
								<?php } ?>
