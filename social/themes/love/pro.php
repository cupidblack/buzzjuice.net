...
if (isset($_GET['code']) && !empty($_GET['code'])) {
    ...
    if (is_array($wo_json_reply) && isset($wo_json_reply['access_token'])) {
        ...
        if (is_array($user_data_array) && !empty($user_data_array) && isset($user_data_array['user_data'])) {
            ...
            $lat             = $user_data['lat'];
            $lng             = $user_data['lng'];
            $last_location_update = $user_data['last_location_update'];
            
            $is_pro          = $user_data['is_pro'];
            $pro_time        = $user_data['pro_time'];
            $pro_type        = $user_data['pro_type'];
            ...
            if( $user ){
                ...
                if(isset($dbEmail['email']) && $dbEmail['email'] == $user_email){
                    ...
                    $re_data    = array(
                        ...
                        'language'       => isset($user_data['language']) ? Secure($user_data['language'], 0) : 'english',
                    
                        // Location
                        'lat'                  => isset($user_data['lat']) ? Secure($user_data['lat'], 0) : '',
                        'lng'                  => isset($user_data['lng']) ? Secure($user_data['lng'], 0) : '',
                        'timezone'             => isset($user_data['timezone']) ? Secure($user_data['timezone'], 0) : '',
                        'last_location_update' => isset($user_data['last_location_update']) ? Secure($user_data['last_location_update'], 0) : '',
                    
                        // System & Meta
                        'ip_address'     => isset($user_data['ip_address']) ? Secure($user_data['ip_address'], 0) : '',
                        'lastseen'       => time(),
                        'type'           => isset($user_data['type']) ? Secure($user_data['type'], 0) : 'user',
                    
                        // PRO / Membership
                        'is_pro'         => isset($user_data['is_pro']) ? Secure($user_data['is_pro'], 0) : 0,
                        'pro_type'       => isset($user_data['pro_type']) ? Secure($user_data['pro_type'], 0) : 0,
                        'pro_time'       => isset($user_data['pro_time']) ? Secure($user_data['pro_time'], 0) : 0,
                    
                    );

                    $updated_user = $user->register($re_data);
                    if ($updated_user['code'] == 200) {
                        $user_id = $updated_user['userId'];
                    } else { var_dump($updated_user); }
			...
			<div class="row">
				<div class="col l3 m6 s12">
					<label class="dt_go_pro_plan">
						<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( '1 Month' );?>" data-price="<?php echo (float)$config->weekly_pro_plan;?>"/>
						<div class="plan">
							<div class="valign-wrapper head">
								<div>
									...
									<div>
										<h5><?php echo __( 'Classic' );?></h5>
										<p><?php echo __( '1 Month' );?></p>
									</div>
								</div>
								<div class="price">
							...
							<div class="mid">
							<p><svg xmlns="http://www.w3.org/2000/svg" width="15.836" height="15.836" viewBox="0 0 15.836 15.836"> <path d="M3647.918,7687.836a7.918,7.918,0,1,1,7.918-7.918A7.921,7.921,0,0,1,3647.918,7687.836Zm-.792-4.751,5.6-5.6-1.116-1.125-4.481,4.481-2.241-2.241-1.116,1.124Z" transform="translate(-3640 -7672)" fill="#2ee93b"/> </svg> <?php echo __( 'View your matches' );?></p>
								<p><svg xmlns="http://www.w3.org/2000/svg" width="15.836" height="15.836" viewBox="0 0 15.836 15.836"> <path d="M3647.918,7687.836a7.918,7.918,0,1,1,7.918-7.918A7.921,7.921,0,0,1,3647.918,7687.836Zm-.792-4.751,5.6-5.6-1.116-1.125-4.481,4.481-2.241-2.241-1.116,1.124Z" transform="translate(-3640 -7672)" fill="#2ee93b"/> </svg> <?php echo __( 'View your visitors' );?></p>
								<p><svg xmlns="http://www.w3.org/2000/svg" width="15.836" height="15.836" viewBox="0 0 15.836 15.836"> <path d="M3647.918,7687.836a7.918,7.918,0,1,1,7.918-7.918A7.921,7.921,0,0,1,3647.918,7687.836Zm-.792-4.751,5.6-5.6-1.116-1.125-4.481,4.481-2.241-2.241-1.116,1.124Z" transform="translate(-3640 -7672)" fill="#2ee93b"/> </svg> <?php echo __( 'See who liked you' );?></p>
								<p><svg xmlns="http://www.w3.org/2000/svg" width="15.836" height="15.836" viewBox="0 0 15.836 15.836"> <path d="M3647.918,7687.836a7.918,7.918,0,1,1,7.918-7.918A7.921,7.921,0,0,1,3647.918,7687.836Zm-.792-4.751,5.6-5.6-1.116-1.125-4.481,4.481-2.241-2.241-1.116,1.124Z" transform="translate(-3640 -7672)" fill="#2ee93b"/> </svg> <?php echo __( 'Review your likes and dislikes' );?></p>
								<p><svg xmlns="http://www.w3.org/2000/svg" width="15.836" height="15.836" viewBox="0 0 15.836 15.836"> <path d="M3647.918,7687.836a7.918,7.918,0,1,1,7.918-7.918A7.921,7.921,0,0,1,3647.918,7687.836Zm-.792-4.751,5.6-5.6-1.116-1.125-4.481,4.481-2.241-2.241-1.116,1.124Z" transform="translate(-3640 -7672)" fill="#2ee93b"/> </svg> <?php echo __( 'View your friend requests' );?></p>
				...
				<div class="col l3 m6 s12">
					<label class="dt_go_pro_plan special">
						<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( '3 Months' );?>" data-price="<?php echo (float)$config->monthly_pro_plan;?>" checked />
						<div class="plan">
							...
							<div class="valign-wrapper head">
								<div>
									...
									<div>
										<h5><?php echo __( 'Silver' );?></h5>
										<p><?php echo __( '3 Months' );?></p>
									</div>
								</div>
								<div class="price">
				...
				<div class="col l3 m6 s12">
					<label class="dt_go_pro_plan">
						<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( '6 Months' );?>" data-price="<?php echo (float)$config->yearly_pro_plan;?>"/>
						<div class="plan">
							<div class="valign-wrapper head">
								<div>
									...
									<div>
										<h5><?php echo __( 'RockStar' );?></h5>
										<p><?php echo __( '6 Months' );?></p>
									</div>
								</div>
								<div class="price">
				...
				<div class="col l3 m6 s12">
					<label class="dt_go_pro_plan">
						<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( '12 Months' );?>" data-price="<?php echo (float)$config->lifetime_pro_plan;?>"/>
						<div class="plan">
							<div class="valign-wrapper head">
								<div>
									...
									<div>
										<h5><?php echo __( 'Premium' );?></h5>
										<p><?php echo __( '12 Months' );?></p>
									</div>
								</div>
								<div class="price">
...
<script>
	...
	// BlueCrownR&D - QDW-PGB Function for Pro Subscriptions
	<?php if ($config->qdw_payment == 'yes') { ?>
		function InitializeQDWPGB() {
			$('#qdw-pgb_btn').attr('onclick', 'InitializeProQDWPGB()');
			$('#qdw-pgb_wallet_modal').modal('open');
		}
		function InitializeProQDWPGB() {
			$('#qdw-pgb_btn').html('<span class="processing"><?php echo __('Please Wait');?></span>');
			$('#qdw-pgb_btn').attr('disabled', 'true');
			const price = getPrice();

			$.post(window.ajax + 'qdwpgb/initialize', { type: 'go_pro', price: price }, function (data) {
				if (data.status == 200) {
					window.location.href = data.url;
				} else {
					$('#qdw-pgb_wallet_alert').html("<div class='alert alert-danger'>" + data.message + "</div>");
					setTimeout(function () {
						$('#qdw-pgb_wallet_alert').html('');
					}, 3000);
				}
				$('#qdw-pgb_btn').html('<span class="processing"><?php echo __('Redirecting');?></span>');
				$('#qdw-pgb_btn').removeAttr('disabled');
			});
		}
	<?php } ?>
