...
<div class="dt_mini_sidebar_links">
	<ul class="home_usr_link">
		<li class="vis <?php if($data['name'] == 'profile'){ echo 'active';}?>">
			<a href="<?php echo $site_url;?>/@<?php echo Auth()->username;?>" data-ajax="/@<?php echo Auth()->username;?>"><img src="<?php echo Auth()->avatar->avatar;?>" alt="<?php echo Auth()->full_name;?>" /> <span><?php echo __( 'Profile' );?></span></a>
		</li>
