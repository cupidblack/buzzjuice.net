            ...
            <div class="nav-wrapper container container container-fluid container_new">
                                ...
                                <?php if( isGenderFree($profile->gender) === false ){ ?>
                                    <li>
										<a href="<?php echo $site_url;?>/pro" data-ajax="/pro" class="prem">
											<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M2 19h20v2H2v-2zM2 5l5 3.5L12 2l5 6.5L22 5v12H2V5zm2 3.841V15h16V8.841l-3.42 2.394L12 5.28l-4.58 5.955L4 8.84z" fill="currentColor"/></svg></span> <?php echo __( 'Get Social' );?>
										</a>
									</li>
                                <?php }?>
                            <?php } ?>
                    ...
                    <ul class="right">
						<li class="credit">
							...
							<?php } ?>
								...
								<div class="how_credtss">
									...
									<svg xmlns="http://www.w3.org/2000/svg" width="13.658" height="15.175" viewBox="0 0 13.658 15.175">
                                        <path 
                                            fill="#030C5E" 
                                            stroke="#030C5E" 
                                            stroke-width="0.4" 
                                            stroke-linejoin="round"
                                            transform="scale(0.05813, 0.075875)" 
                                            d="m 21.714286,200 0,-7.42857 24,-7.42857 0,-100.28577 -45.714286,0 0,-14.85714 45.714286,0 0,-19.9999 -45.714286,0 0,-14.85714 45.714286,0 0,-20.28577 -24,-7.42857 0,-7.42857 L 128,0 q 22.85714,0 41.14286,8.85719 18.28571,8.8571 26.00005,26.28572 l 39.71423,0 0,14.85714 -35.71433,0 Q 200,55.28574 200,60 q -0.28566,4.71426 -1.14286,9.99995 l 36,0 0,14.85714 -40,0 q -7.42857,17.42862 -25.71428,26.00005 Q 150.85714,119.42857 128,120 l -54.857143,0 0,64.57143 24.000003,8 0,7.42857 -75.428574,0 z m 51.428571,-94.85714 54.857143,0 q 11.42857,0 22.28571,-5.14286 10.85715,-5.14286 15.28574,-15.14291 l -92.428593,0 0,20.28577 z m 0,-35.14291 98.142883,0 q 1.28569,-6.28561 1.28569,-9.99995 0,-3.71434 -1.28569,-9.99995 l -98.142883,0 0,19.9999 z m 0,-34.85704 92.285763,0 Q 161.14286,26.57138 150.28571,20.78568 139.42857,14.99997 128,14.85714 l -54.857143,0 0,20.28577 z" 
                                        />
                                        </svg>
                        ...
                        <li class="header_user">
                            ...
                            <a href="javascript:void(0);" data-target="user_dropdown" class="dropdown-trigger btn-flat">
                                <img src="<?php echo $profile->avatar->avatar;?>" alt="<?php echo $profile->full_name;?>" /> <span><?php echo __( 'Hi,' );?> <?php echo $profile->first_name;?></span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path fill="currentColor" d="M12 13.172l4.95-4.95 1.414 1.414L12 16 5.636 9.636 7.05 8.222z"/></svg>
                            </a>
                            <ul id="user_dropdown" class="dropdown-content">
                                ...
                                <li class="header_credits_mobi">
                                    <a href="<?php echo $site_url;?>/pro" data-ajax="/pro" class="waves-effect"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M2 19h20v2H2v-2zM2 5l5 3.5L12 2l5 6.5L22 5v12H2V5zm2 3.841V15h16V8.841l-3.42 2.394L12 5.28l-4.58 5.955L4 8.84z" /></svg> <?php echo __( 'Get Social' );?></a>
                                </li>
                ...
                <?php }else{ ?>
                    <ul class="right">
                        <li class="header_user">
                            <a href="javascript:void(0);" data-target="user_dropdown" class="dropdown-trigger btn-flat">
                                <img src="<?php echo $profile->avatar->avatar;?>" alt="<?php echo $profile->full_name;?>" />
