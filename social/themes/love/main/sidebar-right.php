		...
		?>
			<div class="dt_home_pro_usr">
				<h4 class="bold">
					...
					<?php if( $config->pro_system == 1 ) { ?>
						<?php echo __( 'Social Subscribers' );?>
					<?php } else{ ?>
					...
					?>
						<div class="pro_usr">
							<a href="<?php echo $site_url;?>/@<?php echo $pro_user->username;?>" data-ajax="/@<?php echo $pro_user->username;?>" title="<?php echo $pro_user->username;?>">
								<div><img src="<?php echo GetMedia( $pro_user->avatar );?>" alt="<?php echo $pro_user->username;?>" /></div>
							</a>
						</div>
					<?php } } ?>
				</div>
				<?php if(IS_LOGGED && !empty(auth()) && auth()->is_pro == 0){?>
					<div class="add_me">
						...
						<a href="<?php echo $site_url;?>/pro" data-ajax="/pro" class="prem">
							<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M2 19h20v2H2v-2zM2 5l5 3.5L12 2l5 6.5L22 5v12H2V5zm2 3.841V15h16V8.841l-3.42 2.394L12 5.28l-4.58 5.955L4 8.84z" fill="currentColor"></path></svg></span> <?php echo __( 'Get Social!' );?>
						</a>
					</div>
				<?php } ?>
			</div>
...
<div class="dt_sections">
	<div class="dt_right_side_story">
		...
		<div class="dt_right_side_story_list">
			<div class="images">
				<img src="<?php echo $story->user->avatar->avatar;?>"/>
				<img src="<?php echo $story->story_user->avatar->avatar;?>"/>
			</div>
