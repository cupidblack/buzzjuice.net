...
<script>
  ...
  <div class="sk-circle">\
    ...
    function deleteimage(img){
        ...
        var url = window.ajax + '/profile/delete_avatar';
    ...
    function deleteimageadmin(img,user){
        var src = $(img).parent().parent().find('.fancybox-image').attr('src'); // Looks for the *fancyboxed* image
        var url = window.ajax + '/profile/delete_avatar_admin';
        var formData = new FormData();
        formData.append("id", $(img).attr('data-id') );
    ...
    function privateimage(img){
        var src = $(img).parent().parent().find('.fancybox-image').attr('src'); // Looks for the *fancyboxed* image
        var url = window.ajax + '/profile/private_avatar';
        var formData = new FormData();
            formData.append("id", $(img).attr('data-id') );
    ...
    function unprivateimage(img){
        var src = $(img).parent().parent().find('.fancybox-image').attr('src'); // Looks for the *fancyboxed* image
        var url = window.ajax + '/profile/unprivate_avatar';
        var formData = new FormData();
            formData.append("id", $(img).attr('data-id') );
    ...
    function custom_footer_js(page_name){
        ...
        $("#avatar_profile_img2").fancybox();
        $("#avatar_profile_img").fancybox();
