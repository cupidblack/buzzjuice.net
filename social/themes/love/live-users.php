				...
				<div class="dt_home_match_user dt_live_users_top">
					<div class="valign-wrapper mtc_usr_avtr">
						...
						<div class="usr_thumb isActive">
							<img src="<?php echo $value->user_data->avatar->avatar;?>">
