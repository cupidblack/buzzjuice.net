 ...
 */
class My_AutomateWoo_Earned_Badge_Trigger extends AutomateWoo\Trigger {
	...
	public function init() {
		$this->title = __( 'Earned Badge', 'automatewoo-custom' );
	...
	public function register_hooks() {
		add_filter( 'mycred_user_has_badge', array( $this, 'catch_hooks' ), 10, 5 );
	}
	 ...
	 * @param $user_id
	 */
	public function catch_hooks( $has_badge, $user_id, $badge_id, $level_id, $current_level ) {
