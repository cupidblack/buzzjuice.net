 ...
 */
class My_AutomateWoo_Rank_Demote_Trigger extends AutomateWoo\Trigger {
	...
	public function init() {
		$this->title = __( 'Rank demoted', 'automatewoo-custom' );
	...
	public function register_hooks() {
		...
		add_action( 'mycred_user_got_demoted', array( $this, 'catch_hooks' ), 10, 4 );
	}
	 ...
	 * @param $user_id
	 */
	public function catch_hooks( $user_id, $results, $users_rank, $point_type ) {
