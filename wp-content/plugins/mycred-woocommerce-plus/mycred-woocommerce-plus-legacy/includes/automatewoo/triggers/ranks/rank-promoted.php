 ...
 */
class My_AutomateWoo_Rank_Promote_Trigger extends AutomateWoo\Trigger {
	...
	public function init() {
		$this->title = __( 'Rank promoted', 'automatewoo-custom' );
	...
	public function register_hooks() {
		...
		add_action( 'mycred_user_got_promoted', array( $this, 'catch_hooks' ), 10, 4 );
	}
	 ...
	 * @param $user_id
	 */
	public function catch_hooks( $user_id, $rank_id, $query, $point_type ) {
