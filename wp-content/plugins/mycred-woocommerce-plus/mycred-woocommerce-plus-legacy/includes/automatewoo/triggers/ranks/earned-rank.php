 ...
 */
class My_AutomateWoo_Earned_Rank_Trigger extends AutomateWoo\Trigger {
	...
	public function init() {
		$this->title = __( 'Earned Rank', 'automatewoo-custom' );
	...
	public function register_hooks() {
		...
		add_filter( 'mycred_user_has_rank', array( $this, 'catch_hooks' ), 10, 3 );
	}
	 ...
	 * @param $user_id
	 */
	public function catch_hooks( $has_badge, $user_id, $post_id ) {
