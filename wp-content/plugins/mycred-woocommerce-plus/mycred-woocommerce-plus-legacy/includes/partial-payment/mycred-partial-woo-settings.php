	...
	function mycred_part_woo_settings_fields( $settings ) {
		...
		$plugin = array(
			...
			array(
				...
				'desc'     => __( 'Can users undo a partial payment? Undoing a partial payment will refund the amount the user paid ( For legacy cart ).', 'mycredpartwoo' ),
			...
			array(
				...
				'desc'    => __( 'Select "Yes" if the coupon grants free shipping. A free shipping method must be enabled in your shipping zone and be set to require "a valid free shipping coupon" (see the "Free Shipping Requires" setting).', 'mycredpartwoo' ),
