    ...
    return (
        <div class="mycred-woo-fields-wrapper">
            <div class="mycred-woo-order-total">
                <span class="mycred-woo-order-total-label">{__( 'Order total in points', 'mycred-woocommerce-plus' )}</span>
                <span class="mycred-woo-order-total-value">{49.20}</span>
            </div>
            <div class="mycred-woo-total-credit">
                <span class="mycred-woo-total-credit-label">{__( 'My Balance', 'mycred-woocommerce-plus' )}</span>
