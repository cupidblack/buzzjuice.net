...
use GiveRecurring\PaymentGateways\Stripe\Actions\SubscribeStripeCustomerToPlanWithBECS;
 ...
 * @since 2.0.0
 */
class BECSGatewayModule extends SubscriptionModule implements SubscriptionAmountEditable,
                                                              SubscriptionDashboardLinkable
{
    ...
    public function createSubscription(
        ...
        $subscribeStripeCustomerToPlanWithBECS = (new SubscribeStripeCustomerToPlanWithBECS)(
        ...
        return new SubscriptionComplete(
            $subscribeStripeCustomerToPlanWithBECS->getGatewayTransactionId(),
            $subscribeStripeCustomerToPlanWithBECS->getGatewaySubscriptionId()
        );
    }
