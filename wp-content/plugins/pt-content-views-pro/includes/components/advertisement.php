	...
	static function insert_ads_to_page( $args, $view_type ) {
		...
		if ( $ads_here ) {
			...
			if ( $positions_to_insert ) {
				...
				$limit_this_page = (int) ($has_pagination || $is_block ? PT_CV_Functions::setting_value( PT_CV_PREFIX . 'pagination-items-per-page' ) : PT_CV_Functions::setting_value( PT_CV_PREFIX . 'limit' ));
