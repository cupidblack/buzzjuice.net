		...
		function show_update_message( $plugin_data, $r ) {
			if ( empty( $plugin_data[ 'package' ] ) ) {
				if ( empty( $this->license_key ) ) {
					...
					$text	 = __( 'fix your license issue', 'content-views-pro' );
				}
				echo '<br><br>' . sprintf( __( 'Please %s to enable updates.', 'content-views-pro' ), sprintf( '<strong><a href="%s" target="_blank">%s</a></strong>', $url, $text ) );
			}
		}
