<?php
/**
 * Sliding Widgets Settings Module
 * Settings > Widget Options :: Sliding Widgets
 *
...
/**
 * Create Card Module for Sliding Widgets Options
 *
 * @since 1.0
 * @return void
 */
		...
		if( !is_plugin_active( 'sliding-widget-options/plugin.php' ) ){ ?>
	        <li class="widgetopts-module-card widgetopts-module-type-pro" data-module-id="sliding">
				<div class="widgetopts-module-card-content" style="border-color: #ffb310;">
					...
					<div class="widgetopts-pro-label"><span class="dashicons dashicons-admin-plugins" style="color: #ffb310;"></span></div>
