...
if (!class_exists('WIDGETOPS_Welcome')) {
	class WIDGETOPS_Welcome
	{
		...
		{
			add_dashboard_page(
				__('Getting started with Widget Options Extended', 'widget-options'),
				__('Getting started with Widget Options Extended', 'widget-options'),
...
?>
			<h1><?php _e('Welcome to Widget Options Extended', 'widget-options'); ?></h1>
			<div class="about-text">
				<?php _e('Congratulations for extending your WordPress widgets! You are now rocking with Widget Options Extended - the world\'s most complete widget management plugin yet.', 'widget-options'); ?>
			</div>
			...
			<div class="wrap about-wrap widgetopts-about-wrap">
				...
				<div class="feature-section two-col">
					<div class="col">
						...
						<p><?php printf(__('Widget Options Extended is your all-in-on plugin to take over your widgets like it was built as WordPress core functionality. You can follow the tutorial on the right to see how the plugin works but in reality it\'s so easy and integrated elegantly on each widgets. <a href="%s" target="_blank">Expand your widgets here to view Widget Options</a>.', 'widget-options'), esc_url(admin_url('widgets.php'))); ?>
					</div>
					<div class="col">
				...
				<div class="feature-section two-col">
					...
					<p><?php _e('Widget Options Extended is both easy to use and extremely powerful. We have tons of helpful features that will let you fully manage your widgets and extend functionalities.', 'widget-options'); ?></p>
