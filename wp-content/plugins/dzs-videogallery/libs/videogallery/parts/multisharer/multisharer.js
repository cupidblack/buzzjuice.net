...
const multiSharer_init = () => {
  const $socialBox = (0, _esjquery.$es)('.close-btn-con, .dzs-social-box--main-con');
  (0, _esjquery.$es)(document).on('click', '.dzs-social-box--main-con .close-btn-con,.dzs-social-box--main-con .overlay-background', function (e) {
    var _c = jQuery('.dzsvg-main-con').eq(0);

    $socialBox.removeClass('loading-item loaded-item');
  });
  (0, _esjquery.$es)(document).on('click', '.field-for-view', function () {
    this.select();
...
//# sourceMappingURL=multisharer.js.map