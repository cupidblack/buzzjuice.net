...
class THWCFE_Admin_Form_Block_Field extends THWCFE_Admin_Form{
							...
							<aside>
								...
								<ul class="pp_nav_links">
									...
									if($section !== 'address'){ ?>
										...
										<li class="text-primary pp-nav-link-rules <?php echo esc_attr($section) ?>" data-index="3">
	...
	private function render_form_tab_general_info( $section = '' ){
		...
		<div style="display: inherit;" class="data-panel-content">
			...
			<table class="thwcfe_field_form_tab_general_field_options thwcfe_block_field_options <?php echo esc_attr( $section ); ?>" style="display: none;">
				<?php
					$this->render_form_fragment_options($section);
				?>
			</table>
		</div>
		<?php
	...
	*/
	...
	private function render_form_tab_display_rules(){
		...
		<div style="display: inherit;" class="data-panel-content">
			<table class="thwcfe_pp_table thwcfe-display-rules">
				...
				$this->render_form_fragment_rules_ajax('field', 'block');
				?>
			</table>
		</div>
		<?php
	...
	private function output_form_fragments( $section = ''){
		...
		$this->render_field_form_fragment_fields_wrapper('block');
	}
	...
	private function render_form_field_checkbox( $section = '' ){
        ...
        <table id="thwcfe_field_form_id_checkbox" class="thwcfe_field_form_table" width="100%" style="display:none;">
			...
			//The required option works from wc version 9.8 onwards
			$this->render_form_elm_row_cb($this->field_props['required']);
			$this->render_form_elm_row_cb($this->field_props['enabled']);
	...
	*/
	...
	private function render_form_fragment_options($section = ''){
		//$this->render_form_elm_row($this->field_props['taxable']);
		//$this->render_form_elm_row($this->field_props['tax_class']);
