...
/**
 * Hook for WPAdverts Paid Advert Publication
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_WPAdverts_Publish_Paid_Hook')):
    class myCRED_WPAdverts_Publish_Paid_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'wpadverts_publish_paid_advert',
                'defaults' => array(
                    'creds' => 1,
                    'log' => __('%plural% for publishing a paid advert', 'mycred-toolkit'),
                    'limit' => '0/x'
                )
            ), $hook_prefs, $type);
        }
        ...
        public function run()
        {
            add_action('added_post_meta', array($this, 'mycred_wpadverts_publish_paid_advert'), 10, 4);
            add_action('updated_post_meta', array($this, 'mycred_wpadverts_publish_paid_advert'), 10, 4);
        }

        /**
         * Award points for WPAdverts Paid Advert Publication
         */
        public function mycred_wpadverts_publish_paid_advert($meta_id, $post_id, $meta_key, $meta_value)
        {
            ...
            // Check if advert is paid - use the meta_value directly
            $price = (float) $meta_value;

            // Bail if not a paid advert (price must be greater than 0)
            if ($price <= 0) {
                return;
            }
            ...
            $reference = 'wpadverts_publish_paid_advert';
        ...
        /**
         * Preference for WPAdverts Paid Advert Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3>
                    <?php esc_html_e('Publishing a Paid Advert', 'mycred-toolkit'); ?>
                </h3>
                <div class="row">
