...
/**
 * Hook for Author receiving unfavorites on posts
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_Favorites_Author_Unfavorite_Hook')):
    class myCRED_Favorites_Author_Unfavorite_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'favorites_author_unfavorite',
                'defaults' => array(
                    'creds' => -1,
                    'log' => __('%plural% deducted when your post is unfavorited', 'mycred-toolkit'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            ...
            add_action('favorites_after_favorite', array($this, 'mycred_favorites_author_unfavorite_reward'), 10, 4);
        }
        ...
        /**
         * Award/Deduct points to Author when their post gets unfavorited
         */
        public function mycred_favorites_author_unfavorite_reward($post_id, $status, $site_id, $user_id)
        {
            // Login is required
            ...
            // Only trigger for 'unfavorite' action (status is NOT 'active')
            if ($status === 'active') {
                return;
            }
            ...
            // Don't trigger if user unfavorites their own post
            ...
            $prefs = $this->prefs;
            $reference = 'favorites_author_unfavorite';
         ...
         */
        public function mycred_favorites_author_unfavorite_arrange_data($specific_hook_data)
        {
            $hook_data = array();
        ...
        /**
         * Preference for Author Unfavorite Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <!-- General Author Unfavorite Rewards Starts -->
            <div class="hook-instance">
                <h3><?php esc_html_e('Author gets an unfavorite on any post', 'mycred-toolkit'); ?></h3>
                <div class="row">
            ...
            <!-- General Author Unfavorite Rewards Ends -->

            <!-- Specific Post Author Unfavorite Rewards Starts -->
            <?php
            $specific_data = array(
                array(
                    'creds' => 0,
                    'log' => __('%plural% deducted when post is unfavorited', 'mycred-toolkit'),
                    'select_option' => 0
                ),
            );

            if (!empty($prefs['specific_posts']['creds']) && count($prefs['specific_posts']['creds']) > 0) {
                $specific_data = $this->mycred_favorites_author_unfavorite_arrange_data($prefs['specific_posts']);
            }

            ?>
            <div class="hook-instance" id="specific-hook-favorites-author-unfavorite">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Author gets an unfavorite on a specific post', 'mycred-toolkit'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="favorites_author_unfavorite_specific_row">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-favorites-author-unfavorite-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-favorites-author-unfavorite-hook add_button"
                                        type="button">Add More</button>
                                    <button class="button button-small mycred-remove-specific-favorites-author-unfavorite-hook"
            ...
            <!-- Specific Post Author Unfavorite Rewards Ends -->
