...
/**
 * myCRED_ninjaforms_Specific_Field_Value_Specific_Form_Hook class
 * Creds for form submit specific field value on specific form events updates
 * 
 * 
 */
if (!class_exists('myCRED_ninjaforms_Specific_Field_Value_Specific_Form_Hook') && class_exists('myCRED_Hook')) {

	class myCRED_ninjaforms_Specific_Field_Specific_form_Hook extends myCRED_Hook {
	...
	public function __construct( $hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY ) {
	  ...
	  /**
		...
		public function run() {
				...
				add_action( 'ninja_forms_after_submission',  array( $this,'mycred_nf_specific_field_value_specific_form_submission'), 40);
			
        }

        public function mycred_nf_specific_field_value_specific_form_submission($data) {
		    ...
		    $fields = $data['fields'];
		      ...
		      foreach ( $fields as $field ) { 
		        ...
		        $field_label = $field['label'];
		           ...
		           if(in_array( $field['label'],$this->prefs['specific_field_specifc_form']['field_name'] )) {

                    $hook_index_field_name = array_search( $field['label'], $this->prefs['specific_field_specifc_form']['field_name'] );
                  ...
                  if( $hook_index_field_name === false ){
                    ...
                    if( $this->prefs['specific_field_specifc_form']['field_name'] == $field['label'] && $value == 0 ) {
		...
		public function preferences() {
            ...
            $specific_form_data = array(
                         array(
                            'creds' => 0,
                            'log' => __('%plural% for Submitting a Specific Field Value on Specific Form', 'mycred-toolkit'),
                            'limit' => '0/x',
                            'select_post' => 0,
                            'field_name' => '',
                            'field_value' => '',
            ...
            if ( count( $prefs['specific_field_specifc_form']['creds'] ) > 0 ) {
                   ...
                   $specific_form_data = $this->mycred_ninjaforms_arrange_data( $prefs['specific_field_specifc_form'] );
                            ...
                            <div class="row">
                            	  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'Select a Form', 'select_post' ); ?></label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label><?php _e( 'Enter Field Name', 'field_name' ); ?></label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="<?php echo $this->specific_field_name(array('specific_field_specifc_form' => 'creds')); ?>" id="<?php echo esc_attr($this->field_id(array('specific_field_specifc_form' => 'creds'))); ?>" value="<?php echo esc_attr($this->core->number( $label['creds'])); ?>" class="form-control mycred-form-specific-field-value-specific-form-creds" />
                                    </div>
                                </div>   
                            </div>
                            <div class="row">
		...
		public function sanitise_preferences( $data ) {
              ...
              if ( isset( $data['specific_field_value'] ) && is_array( $data['specific_field_value'] ) ) {
