...
/**
 * Hook for StudioCart Order Refunded
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_StudioCart_Refund_Hook')):
    class myCRED_StudioCart_Refund_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'studiocart_refund',
                'defaults' => array(
                    'creds' => -1,
                    'log' => __('%plural% deduction for refunded order', 'mycred-toolkit'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            // Hook into StudioCart order refunded
            add_action('sc_order_refunded', array($this, 'mycred_studiocart_order_refunded'), 10, 3);
        }
        ...
        /**
         * Award/Deduct points for StudioCart Order Refunded
         */
        public function mycred_studiocart_order_refunded($status, $order_data, $order_type)
        {
            ...
            // Only process refunded main orders
            if ($status !== 'refunded' && $current_order_status !== 'refunded')
                return;
            ...
            if (
                ...
                if (
                    ...
                    // Check for duplicate entry (don't deduct twice for the same refund)
        ...
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Refund order for any product', 'mycred-toolkit'); ?></h3>
                <div class="row">
            ...
            $specific_data = array(
                array(
                    'creds' => 0,
                    'log' => __('%plural% for refunding order', 'mycred-toolkit'),
                    'select_option' => 0
                ),
            );
            ...
            ?>
            <div class="hook-instance" id="specific-hook-studiocart-refund">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Refund order for specific product', 'mycred-toolkit'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <?php foreach ($specific_data as $hook_idx => $label) { ?>
                    <div class="studiocart_refund_specific_row">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-studiocart-refund-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-studiocart-refund-hook add_button"
                                        type="button">Add More</button>
                                    <button class="button button-small mycred-remove-specific-studiocart-refund-hook"
