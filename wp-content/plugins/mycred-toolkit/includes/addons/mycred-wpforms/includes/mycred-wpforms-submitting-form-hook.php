...
/**
 * myCRED_wpforms_Submit_Form_Hook class
 * Creds for form submit events updates
 * 
 * 
 */
if (!class_exists('myCRED_wpforms_Submit_Form_Hook') && class_exists('myCRED_Hook')) {
class myCRED_wpforms_Submit_Form_Hook extends myCRED_Hook {
	...
	public function __construct( $hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY ) {
		...
		parent::__construct( array(
			...
			'defaults' => array(
				 		'creds' => 0,
                        'log' => __('%plural% for Successfully Submitting a form', 'mycred-wpforms'), 
                        'limit' => '0/x',
       ...
       /**
		...
		public function run() {
				...
				add_action( 'wpforms_process_complete',  array( $this,'mycred_wp_forms_submission'), 40, 4 );
		 ...
		 * 
		 */
		public function mycred_wp_forms_submission( $fields, $entry, $form_data, $entry_id ) {
...
<?php 
                     ...
                     $specific_form_data = array(
	                     array(
	                        'creds' => 0,
	                        'log' => __('%plural% for Successfully Submitting a specific form', 'mycred-wpforms'),
	                        'limit' => '0/x',
	                        'select_post' => 0,
                   ...
                   if ( count( $prefs['successful_submit_form']['creds'] ) > 0 ) {
                    ...
                    $specific_form_data = $this->mycred_wpforms_arrange_data( $prefs['successful_submit_form'] );
