...
/**
 * Hook for FluentCRM - Contact Removed from List
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_FluentCRM_Lists_Removed_Hook')):
    class myCRED_FluentCRM_Lists_Removed_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'fluentcrm_list_removed',
                'defaults' => array(
                    'creds' => 1,
                    'log' => __('%plural% for getting removed from a list in FluentCRM', 'mycred-toolkit'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            // Hook into FluentCRM when contact is removed from lists
            add_action('fluent_crm/contact_removed_from_lists', array($this, 'mycred_fluentcrm_list_removed'), 10, 3);
        }
        ...
        /**
         * Award points for Contact Removed from List
         */
        public function mycred_fluentcrm_list_removed($contact, $listIds, $source = 'wp-admin')
        {
            // Get contact ID
            $contact_id = 0;
            ...
            $prefs = $this->prefs;
            $reference = 'fluentcrm_list_removed';
            ...
            // Process each list that contact was removed from
            foreach ($listIds as $list_id) {
                ...
                if (
                    ...
                    if (
                        ...
                        // Check if user already got points for this specific list removal
                ...
                // Check if user already got points for this list removal
                if ($this->core->has_entry($reference, $list_id, $user_id)) {
                    continue;
                }
         ...
         */
        public function mycred_fluentcrm_lists_removed_arrange_data($specific_hook_data)
        {
            $hook_data = array();
        ...
        /**
         * Preference for FluentCRM Lists Removed Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <!-- General List Removed Rewards Starts -->
            <div class="hook-instance">
                <h3><?php esc_html_e('Removed from any list', 'mycred-toolkit'); ?></h3>
                <div class="row">
            ...
            <!-- General List Removed Rewards Ends -->

            <!-- Specific List Removed Rewards Starts -->
            <?php
            $specific_data = array(
                array(
                    'creds' => 0,
                    'log' => __('%plural% for getting removed from a specific list', 'mycred-toolkit'),
                    'select_option' => 0
                ),
            );

            if (!empty($prefs['specific_lists']['creds']) && count($prefs['specific_lists']['creds']) > 0) {
                $specific_data = $this->mycred_fluentcrm_lists_removed_arrange_data($prefs['specific_lists']);
            }

            ?>
            <div class="hook-instance" id="specific-hook-fluentcrm-lists-removed">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Removed from specific list', 'mycred-toolkit'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="fluentcrm_lists_removed_specific_row">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-fluentcrm-lists-removed-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-fluentcrm-lists-removed-hook add_button" type="button">Add
                                        More</button>
                                    <button class="button button-small mycred-remove-specific-fluentcrm-lists-removed-hook"
            ...
            <!-- Specific List Removed Rewards Ends -->
