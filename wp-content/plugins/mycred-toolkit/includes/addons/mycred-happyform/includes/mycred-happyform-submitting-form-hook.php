 ...
 * 
 */
 if ( ! class_exists( 'myCRED_Happyform_Submit_Form_Hook' ) ) :
 	class myCRED_Happyform_Submit_Form_Hook extends myCRED_Hook {
        ...
        function __construct( $hook_prefs, $type = 'mycred_default' ) {
            ...
            parent::__construct( array(
                'id' => 'happyform_successful_submit_form',
                'defaults' => array( 
                    'creds'         => 0,
        ...
        public function run() {
            ...
            if ( is_user_logged_in() ) {
                ...
                add_action( 'happyforms_submission_success', array( $this, 'mycred_happyform_submission' ), 10, 2 );
            }

        }

        public function mycred_happyform_submission($submission, $form) {
            ...
            if ( $this->core->has_entry( 'happyform_successful_submit_form', $form_id, $user_id) ) return;

                // Execute
                $this->core->add_creds(
                    'happyform_successful_submit_form',
                    $user_id,
                    $this->prefs['creds'],
                    $this->prefs['log'],
                    $form_id,
