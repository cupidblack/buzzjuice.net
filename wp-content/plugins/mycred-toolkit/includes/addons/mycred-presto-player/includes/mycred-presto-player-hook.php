...
/**
 * Hook for Presto Player
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_Presto_Player_Hook')):
    class myCRED_Presto_Player_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'presto_player_video',
                'defaults' => array(
                    'creds' => 1,
                    'log' => __('%plural% for watching a video', 'mycred-toolkit'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            ...
            add_action('presto_player_progress', array($this, 'mycred_presto_player_progress'), 10, 3);
         ...
         */
        public function mycred_presto_player_progress($id, $percent, $visit_time)
        {
            ...
            // Only award if video is fully watched (100%)
            if ($percent < 100) {
                return;
            }
            ...
            if ($specific_enabled && !empty($prefs['specific_videos']['select_option']) && $post_id) {
                ...
                if ($hook_index !== false) {
                    // Video is in specific list - award specific credits ONLY
         ...
         */
        public function mycred_presto_player_arrange_data($specific_hook_data)
        {
            $hook_data = array();
        ...
        /**
         * Preference for Presto Player Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <!-- General Video Rewards Starts -->
            <div class="hook-instance">
                <h3><?php esc_html_e('Watch any video', 'mycred-toolkit'); ?></h3>
                <div class="row">
            ...
            <!-- General Video Rewards Ends -->

            <!-- Specific Video Rewards Starts -->
            <?php
            $specific_data = array(
                array(
                    'creds' => 0,
                    'log' => __('%plural% for watching video', 'mycred-toolkit'),
                    'select_option' => 0
                ),
            );

            if (!empty($prefs['specific_videos']['creds']) && count($prefs['specific_videos']['creds']) > 0) {
                $specific_data = $this->mycred_presto_player_arrange_data($prefs['specific_videos']);
            }

            ?>
            <div class="hook-instance" id="specific-hook-presto-player">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Watch specific video', 'mycred-toolkit'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="presto_player_specific_row">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-presto-player-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-presto-player-hook add_button"
                                        type="button">Add More</button>
                                    <button class="button button-small mycred-remove-specific-presto-player-hook"
