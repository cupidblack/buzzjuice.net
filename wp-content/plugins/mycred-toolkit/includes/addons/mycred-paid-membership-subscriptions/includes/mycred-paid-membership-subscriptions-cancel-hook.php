...
/**
 * Hook for Paid Membership Subscriptions plugin - Cancel Subscription
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('MyCred_PMS_Cancel_Subscription_Hook')):
    class MyCred_PMS_Cancel_Subscription_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'pms_cancel_subscription',
                'defaults' => array(
                    'creds' => 10,
                    'log' => __('%plural% for cancelling subscription', 'myCred_pms'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            add_action('pms_cancel_member_subscription_successful', array($this, 'mycred_paid_membership_subscriptions_cancel_subscription'), 10, 2);
        }
        ...
        /**
         * Award points for Cancelling Subscription
         */
        public function mycred_paid_membership_subscriptions_cancel_subscription($member_data, $member_subscription)
        {
            ...
            $prefs = $this->prefs;
            $reference = 'pms_cancel_subscription';
        ...
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Cancel any subscription', 'myCred_pms'); ?></h3>
                <div class="row">
            ...
            <div class="hook-instance" id="specific-hook-pms">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Cancel specific subscription', 'myCred_pms'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="pms_subscription_specific_row_cancel">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-pms-subscription-cancel-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-pms-subscription-cancel-hook add_button"
                                        type="button">Add
                                        More
                                    </button>
                                    <button class="button button-small mycred-remove-specific-pms-subscription-cancel-hook"
                                        type="button">Remove
                                    </button>
                                </div>
                            </div>
