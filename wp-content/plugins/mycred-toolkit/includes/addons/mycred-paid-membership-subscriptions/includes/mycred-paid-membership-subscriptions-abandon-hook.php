...
/**
 * Hook for Paid Membership Subscriptions plugin - Abandon Subscription
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('MyCred_PMS_Abandon_Subscription_Hook')):
    class MyCred_PMS_Abandon_Subscription_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'pms_abandon_subscription',
                'defaults' => array(
                    'creds' => 10,
                    'log' => __('%plural% for abandoning subscription', 'myCred_pms'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            add_action('pms_abandon_member_subscription_successful', array($this, 'mycred_paid_membership_subscriptions_abandon_subscription'), 10, 2);
        }
        ...
        /**
         * Award points for Abandoning Subscription
         */
        public function mycred_paid_membership_subscriptions_abandon_subscription($member_data, $member_subscription)
        {
            // Ensure we have necessary data
            if (!isset($member_subscription->subscription_plan_id)) {
                return;
            }

            $subscription_plan_id = $member_subscription->subscription_plan_id;
            $user_id = isset($member_data['user_id']) ? $member_data['user_id'] : get_current_user_id();
            ...
            $prefs = $this->prefs;
            $reference = 'pms_abandon_subscription';
        ...
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Abandon any subscription', 'myCred_pms'); ?></h3>
                <div class="row">
            ...
            <div class="hook-instance" id="specific-hook-pms">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Abandon specific subscription', 'myCred_pms'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="pms_subscription_specific_row_abandon">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-pms-subscription-abandon-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-pms-subscription-abandon-hook add_button"
                                        type="button">Add
                                        More
                                    </button>
                                    <button class="button button-small mycred-remove-specific-pms-subscription-abandon-hook"
                                        type="button">Remove
                                    </button>
                                </div>
                            </div>
