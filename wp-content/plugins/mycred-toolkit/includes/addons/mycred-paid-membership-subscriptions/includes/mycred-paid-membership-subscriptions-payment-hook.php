...
/**
 * Payment Hook for Paid Membership Subscriptions plugin
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('MyCred_PMS_Payment_Subscription_Hook')):
    class MyCred_PMS_Payment_Subscription_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'pms_payment_subscription',
                'defaults' => array(
                    'creds' => 10,
                    'log' => __('%plural% for payment on subscription', 'myCred_pms'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            add_action('pms_payment_update', array($this, 'mycred_pms_pay_subscription'), 10, 3);
        }
        ...
        /**
         * Award points for Payment on Subscription
         */
        public function mycred_pms_pay_subscription($payment_id, $new_data, $old_data)
        {
            ...
            // Preventing double awarding if it was already completed (though update usually implies change)
            ...
            $prefs = $this->prefs;
            $reference = 'pms_payment_subscription';
        ...
        /**
         * Preference for PMS Payment Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Pay for any subscription', 'myCred_pms'); ?></h3>
                <div class="row">
            ...
            ?>
            <div class="hook-instance" id="specific-hook-pms-payment">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Pay for specific subscription', 'myCred_pms'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="pms_payment_specific_row">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-pms-payment-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-pms-payment-hook add_button"
                                        type="button">Add
                                        More
                                    </button>
                                    <button class="button button-small mycred-remove-specific-pms-payment-hook" type="button">Remove
                                    </button>
                                </div>
                            </div>
                        </div>
