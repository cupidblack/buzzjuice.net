...
if ( ! class_exists( 'myCRED_Anspress_New_Answer_Hook' ) ) :
	class myCRED_Anspress_New_Answer_Hook extends myCRED_Hook {
		...
		public function anspress_new_answer( $post_id, $post ) {
			...
			if ( $this->has_entry( 'anspress_after_new_answer', $post_id, $user_id, $this->prefs['creds'], $this->prefs['log'] ) ) {
return;
			}
			if ( $this->over_hook_limit( 'limit', 'anspress_after_new_answer', $user_id, '' ) ) {
return;
			}
