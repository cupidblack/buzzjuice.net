...
/**
 * Hook for Metform form submission
 * 
 * 
 */
 if ( ! class_exists( 'myCRED_Everestform_Submit_Form_Hook' ) ) :
 	class myCRED_Everestform_Submit_Form_Hook extends myCRED_Hook {
        ...
        function __construct( $hook_prefs, $type = 'mycred_default' ) {
            ...
            parent::__construct( array(
                'id' => 'everestform_successful_submit_form',
                'defaults' => array( 
                    'creds'         => 0,
        ...
        public function run() {
            ...
            if ( is_user_logged_in() ) {
                ...
                add_action( 'everest_forms_process_complete', array( $this, 'mycred_everestform_submission' ), 10, 4 );
            }

        }

        public function mycred_everestform_submission($form_fields, $entry, $form_data, $entry_id) {
            ...
            if ( $this->core->has_entry( 'everestform_successful_submit_form', $form_id, $user_id) ) return;

                // Execute
                $this->core->add_creds(
                    'everestform_successful_submit_form',
                    $user_id,
                    $this->prefs['creds'],
                    $this->prefs['log'],
                    $form_id,
