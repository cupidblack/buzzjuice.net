...
/**
 * Hook for Advanced Ads Unpublication
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_Advanced_Ads_Unpublish_Hook')):
    class myCRED_Advanced_Ads_Unpublish_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'advanced_ads_unpublication',
                'defaults' => array(
                    'creds' => -1,
                    'log' => __('%plural% for unpublishing an ad', 'mycred-toolkit'),
                    'limit' => '0/x'
                )
            ), $hook_prefs, $type);
        }
        ...
        public function run()
        {
            add_action('advanced-ads-ad-status-unpublished', array($this, 'mycred_advanced_ads_ad_unpublished'), 10);
        }

        /**
         * Award/Deduct points for Advanced Ads Unpublication
         */
        public function mycred_advanced_ads_ad_unpublished($ad)
        {
            ...
            $reference = 'advanced_ads_unpublication';
        ...
        /**
         * Preference for Advanced Ads Unpublication Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Unpublishing an Ad', 'mycred-toolkit'); ?></h3>
                <div class="row">
