 ...
 * 
 */
 if ( ! class_exists( 'myCRED_Kaliform_Submit_Form_Hook' ) ) :
 	class myCRED_Kaliform_Submit_Form_Hook extends myCRED_Hook {
        ...
        function __construct( $hook_prefs, $type = 'mycred_default' ) {
            ...
            parent::__construct( array(
                'id' => 'kaliform_successful_submit_form',
                'defaults' => array( 
                    'creds'         => 0,
        ...
        public function run() {
            ...
            if ( is_user_logged_in() ) {
                ...
                add_action( 'kaliforms_before_form_process_action', array( $this, 'mycred_kaliform_submission' ), 10, 1 );
            }

        }

        public function mycred_kaliform_submission($data_form) {
            ...
            if ( $this->core->has_entry( 'kaliform_successful_submit_form', $form_id, $user_id) ) return;

                // Execute
                $this->core->add_creds(
                    'kaliform_successful_submit_form',
                    $user_id,
                    $this->prefs['creds'],
                    $this->prefs['log'],
                    $form_id,
