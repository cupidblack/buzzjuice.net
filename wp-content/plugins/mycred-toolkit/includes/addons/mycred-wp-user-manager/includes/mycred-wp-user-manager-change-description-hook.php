...
/**
 * Hook for WP User Manager: Change Description
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_WP_User_Manager_Change_Description_Hook')):
    class myCRED_WP_User_Manager_Change_Description_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                ...
                'defaults' => array(
                    'creds' => 1,
                    'log' => __('%plural% for updating profile description', 'mycred-toolkit'),
                    'limit' => '0/x'
                )
            ), $hook_prefs, $type);
        }
        ...
        public function run()
        {
            add_action('wpum_before_user_update', array($this, 'mycred_wp_user_manager_change_description'), 10, 3);
        }

        /**
         * Award points for WP User Manager Description Change
         */
        public function mycred_wp_user_manager_change_description($form, $values, $user_id)
        {
        ...
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Updating Profile Description', 'mycred-toolkit'); ?></h3>
                <div class="row">
