...
/**
 * Hook for WP User Manager: Change Avatar
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_WP_User_Manager_Avatar_Hook')):
    class myCRED_WP_User_Manager_Avatar_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'wpum_avatar_change',
                'defaults' => array(
                    'creds' => 1,
                    'log' => __('%plural% for changing profile avatar', 'mycred-toolkit'),
                    'limit' => '0/x'
                )
            ), $hook_prefs, $type);
        }
        ...
        public function run()
        {
            add_action('wpum_user_update_change_avatar', array($this, 'mycred_wp_user_manager_change_avatar'), 10, 2);
        }

        /**
         * Award points for WP User Manager Avatar Change
         */
        public function mycred_wp_user_manager_change_avatar($user_id, $image_url)
        {
        ...
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Changing Profile Avatar', 'mycred-toolkit'); ?></h3>
                <div class="row">
