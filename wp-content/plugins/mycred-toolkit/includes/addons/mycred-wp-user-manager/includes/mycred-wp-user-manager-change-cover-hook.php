...
/**
 * Hook for WP User Manager: Change Cover
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_WP_User_Manager_Change_Cover_Hook')):
    class myCRED_WP_User_Manager_Change_Cover_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'wpum_cover_change',
                'defaults' => array(
                    'creds' => 1,
                    'log' => __('%plural% for changing profile cover', 'mycred-toolkit'),
                    'limit' => '0/x'
                )
            ), $hook_prefs, $type);
        }
        ...
        public function run()
        {
            add_action('wpum_user_update_change_cover', array($this, 'mycred_wp_user_manager_change_cover'), 10, 2);
        }

        /**
         * Award points for WP User Manager Cover Change
         */
        public function mycred_wp_user_manager_change_cover($user_id, $image_url)
        {
        ...
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Changing Profile Cover', 'mycred-toolkit'); ?></h3>
                <div class="row">
