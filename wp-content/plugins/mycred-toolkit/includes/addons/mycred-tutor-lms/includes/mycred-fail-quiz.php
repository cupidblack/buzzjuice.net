				 ...
				 <div class="row">
					<div class="col-lg-12">
						...
						<div>
							...
							<input type="checkbox" name="<?php echo esc_attr( $this->field_name( 'mycred_check_fail_quiz' ) ); ?>" id="<?php echo esc_attr( $this->field_id( 'mycred_check_fail_quiz' ) ); ?>" value="1" 
																	<?php
																	if ( $prefs['mycred_check_fail_quiz'] == '1') {
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
									...
									<input type="text" name="<?php echo esc_attr( $this->mycred_tutor_lms_quiz_fail_name($obj->mycred_type, 'log' ) ); ?>" id="<?php echo esc_attr( $obj->field_id( 'log' ) ); ?>" placeholder="<?php esc_html_e( 'required', 'mycred-toolkit' ); ?>" value="<?php echo esc_attr( $prefs['log'] ); ?>" class="form-control mycred-tutor_lms-log" />
										...
										foreach ($contents as $content => $value) {
											...
											if ( isset( $prefs['select_course_fail'] ) && isset( $prefs['select_quiz_fail'] ) ) {
												...
												<option value="<?php echo esc_attr( $value->ID ); ?>"
																		  <?php
													echo ( $prefs['select_quiz_fail'] != $value->ID && in_array( $value->ID, $this->prefs['tutor_lms_quiz_fail']['select_quiz_fail'] ) ) ?  'disabled' : ''
																			?>
																		  <?php echo selected($prefs['select_quiz_fail'], $value->ID); ?>>
