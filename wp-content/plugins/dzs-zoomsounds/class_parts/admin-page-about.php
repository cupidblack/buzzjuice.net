...
?>
  ...
  <div class="wrap wrap-dzsap-about" style="max-width: 1200px;">
    ...
    <div class="about-text"><?php echo esc_html__(`Congratulations! You are about to use the most powerful audio player.`, DZSAP_ID); ?>  </div>
...
,toggle_type: 'accordion'
    ...
    <a href="<?php echo admin_url('admin.php?page=dzsap_menu&donotshowaboutagain=on'); ?>" target=""
       class="button-primary action"><i class="fa fa-check"></i> <?php echo esc_html__('Got it! Lets go.', DZSAP_ID); ?>
    </a>
  </div>
<?php
