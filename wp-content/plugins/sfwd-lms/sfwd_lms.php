...
update_option('nss_plugin_license_sfwd_lms','OYLITE0000000005603B1EBE56D0D7F8');
update_option('nss_plugin_license_email_sfwd_lms','noreply@oylite.com');
...
return ['headers'=>[],'body'=>json_encode(['subscription_type'=>'learndash_legacy','plan_code'=>'plus','site_limit'=>100,'expiry'=>2524591861,'token'=>'OYLITE0000000005603B1EBE59708542','product'=>'learndash']),'response'=>['code'=>200,'message'=>'OK']];
    }
