...
if ( ! class_exists( 'myCRED_Anspress_Publish_Comment_Hook' ) ) :
	class myCRED_Anspress_Publish_Comment_Hook extends myCRED_Hook {
		...
		public function anspress_publish_comment( $comment_id ) {
			...
			if ( $this->has_entry( 'anspress_publish_comment', 'anspress_publish_comment', $user_id, $this->prefs['creds'], $this->prefs['log'] ) ) {
return;
			}
			if ( $this->over_hook_limit( 'limit', 'anspress_publish_comment', $user_id, '' ) ) {
return;
			}
