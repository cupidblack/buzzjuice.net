 ...
 * 
 */
 if ( ! class_exists( 'myCRED_Fluentform_Submit_Form_Hook' ) ) :
 	class myCRED_Fluentform_Submit_Form_Hook extends myCRED_Hook {
        ...
        function __construct( $hook_prefs, $type = 'mycred_default' ) {
            ...
            parent::__construct( array(
                'id' => 'fluentform_successful_submit_form',
                'defaults' => array( 
                    'creds'         => 0,
        ...
        public function run() {
            ...
            if ( is_user_logged_in() ) {
                ...
                add_action( 'fluentform/before_submission_confirmation', array( $this, 'mycred_fluentform_submission' ), 10, 3 );
            }

        }

        public function mycred_fluentform_submission($submission_id, $form_data, $form) {
            ...
            if ( $this->core->has_entry( 'fluentform_successful_submit_form', $form_id, $user_id) ) return;

                // Execute
                $this->core->add_creds(
                    'fluentform_successful_submit_form',
                    $user_id,
                    $this->prefs['creds'],
                    $this->prefs['log'],
                    $form_id,
