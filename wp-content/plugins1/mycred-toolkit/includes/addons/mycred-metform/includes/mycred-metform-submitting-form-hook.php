 ...
 * 
 */
 if ( ! class_exists( 'myCRED_Metform_Submit_Form_Hook' ) ) :
 	class myCRED_Metform_Submit_Form_Hook extends myCRED_Hook {
        ...
        function __construct( $hook_prefs, $type = 'mycred_default' ) {
            ...
            parent::__construct( array(
                'id' => 'metform_successful_submit_form',
                'defaults' => array( 
                    'creds'         => 0,
        ...
        public function run() {
            ...
            if ( is_user_logged_in() ) {
                ...
                add_action( 'metform_after_store_form_data', array( $this, 'mycred_metform_submission' ), 10, 4 );
            }

        }

        public function mycred_metform_submission($form_id, $form_data, $form_settings, $attributes) {
            ...
            if ( $this->core->has_entry( 'metform_successful_submit_form', $form_id, $user_id) ) return;

                // Execute
                $this->core->add_creds(
                    'metform_successful_submit_form',
                    $user_id,
                    $this->prefs['creds'],
                    $this->prefs['log'],
                    $form_id,
