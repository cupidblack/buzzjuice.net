...
/**
 * Hook for FluentCRM - Contact Tag Removed
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_FluentCRM_Tags_Removed_Hook')):
    class myCRED_FluentCRM_Tags_Removed_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                ...
                'defaults' => array(
                    'creds' => 1,
                    'log' => __('%plural% for getting a tag removed in FluentCRM', 'mycred-toolkit'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            // Hook into FluentCRM when tags are removed from a contact
            add_action('fluent_crm/contact_removed_from_tags', array($this, 'mycred_fluentcrm_tag_removed'), 10, 3);
        }
        ...
        /**
         * Award points for Tag Removed from Contact
         */
        public function mycred_fluentcrm_tag_removed($contact, $tagIds, $source = 'wp-admin')
        {
            // Get contact ID
            $contact_id = 0;
            ...
            $prefs = $this->prefs;
            $reference = 'fluentcrm_tag_removed';
            ...
            // Process each tag that was removed
            foreach ($tagIds as $tag_id) {
                ...
                if (
                    ...
                    if (
                        ...
                        // Check if user already got points for this specific tag removal
                ...
                // Check if user already got points for this tag removal
                if ($this->core->has_entry($reference, $tag_id, $user_id)) {
                    continue;
                }
         ...
         */
        public function mycred_fluentcrm_tags_removed_arrange_data($specific_hook_data)
        {
            $hook_data = array();
        ...
        /**
         * Preference for FluentCRM Tags Removed Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <!-- General Tag Removed Rewards Starts -->
            <div class="hook-instance">
                <h3><?php esc_html_e('Tag removed from any contact', 'mycred-toolkit'); ?></h3>
                <div class="row">
            ...
            <!-- General Tag Removed Rewards Ends -->

            <!-- Specific Tag Removed Rewards Starts -->
            <?php
            $specific_data = array(
                array(
                    'creds' => 0,
                    'log' => __('%plural% for getting a specific tag removed', 'mycred-toolkit'),
                    'select_option' => 0
                ),
            );

            if (!empty($prefs['specific_tags']['creds']) && count($prefs['specific_tags']['creds']) > 0) {
                $specific_data = $this->mycred_fluentcrm_tags_removed_arrange_data($prefs['specific_tags']);
            }

            ?>
            <div class="hook-instance" id="specific-hook-fluentcrm-tags-removed">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Tag removed from specific contact', 'mycred-toolkit'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="fluentcrm_tags_removed_specific_row">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-fluentcrm-tags-removed-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-fluentcrm-tags-removed-hook add_button" type="button">Add
                                        More</button>
                                    <button class="button button-small mycred-remove-specific-fluentcrm-tags-removed-hook"
            ...
            <!-- Specific Tag Removed Rewards Ends -->
