...
/**
 * Hook for User Unfavoriting Posts
 * @since 1.0
 * @version 1.0
 */
if (!class_exists('myCRED_Favorites_Unfavorite_Hook')):
    class myCRED_Favorites_Unfavorite_Hook extends myCRED_Hook
    {
        ...
        function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            ...
            parent::__construct(array(
                'id' => 'favorites_unfavorite',
                'defaults' => array(
                    'creds' => -1,
                    'log' => __('%plural% deducted for unfavoriting a post', 'mycred-toolkit'),
                    'limit' => '0/x',
        ...
        public function run()
        {
            ...
            add_action('favorites_after_favorite', array($this, 'mycred_favorites_unfavorite'), 10, 4);
        }
        ...
        /**
         * Deduct/Award points for Unfavoriting a Post
         */
        public function mycred_favorites_unfavorite($post_id, $status, $site_id, $user_id)
        {
            // Login is required
            ...
            $prefs = $this->prefs;
            $reference = 'favorites_unfavorite';
         ...
         */
        public function mycred_favorites_unfavorite_arrange_data($specific_hook_data)
        {
            $hook_data = array();
        ...
        /**
         * Preference for Unfavorite Hook
         * @since 1.0
         * @version 1.0
         */
        public function preferences()
        {
            ...
            <!-- General Unfavorite Rewards Starts -->
            <div class="hook-instance">
                <h3><?php esc_html_e('Unfavorite any post', 'mycred-toolkit'); ?></h3>
                <div class="row">
            ...
            <!-- General Unfavorite Rewards Ends -->

            <!-- Specific Post Unfavorite Rewards Starts -->
            <?php
            $specific_data = array(
                array(
                    'creds' => 0,
                    'log' => __('%plural% deducted for unfavoriting post', 'mycred-toolkit'),
                    'select_option' => 0
                ),
            );

            if (!empty($prefs['specific_posts']['creds']) && count($prefs['specific_posts']['creds']) > 0) {
                $specific_data = $this->mycred_favorites_unfavorite_arrange_data($prefs['specific_posts']);
            }

            ?>
            <div class="hook-instance" id="specific-hook-favorites-unfavorite">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hook-title">
                            <h3><?php esc_html_e('Unfavorite specific post', 'mycred-toolkit'); ?></h3>
                        </div>
                    </div>
                </div>
                ...
                foreach ($specific_data as $hook_idx => $label) {
                    ?>
                    <div class="favorites_unfavorite_specific_row">
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mycred-favorites-unfavorite-options"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 field_wrapper">
                                <div class="form-group textright">
                                    <button class="button button-small mycred-add-specific-favorites-unfavorite-hook add_button"
                                        type="button">Add More</button>
                                    <button class="button button-small mycred-remove-specific-favorites-unfavorite-hook"
            ...
            <!-- Specific Post Unfavorite Rewards Ends -->
