...
if (!class_exists('myCRED_FluentCart_Full_Refund_Hook')) :
    class myCRED_FluentCart_Full_Refund_Hook extends myCRED_Hook
    {
        public function __construct($hook_prefs, $type = MYCRED_DEFAULT_TYPE_KEY)
        {
            parent::__construct(array(
                'id' => 'fluentcart_order_full_refund',
                'defaults' => array(
                    'creds' => 1,
                    'log'   => __('%plural% for order fully refunded in FluentCart', 'mycred-toolkit'),
                    'limit' => '0/x',
                )
            ), $hook_prefs, $type);
        }
        ...
        public function run()
        {
            add_action('fluent_cart/order_fully_refunded', array($this, 'mycred_fluentcart_full_refund'), 10, 1);
        }

        public function mycred_fluentcart_full_refund($data)
        {
            ...
            $reference = 'fluentcart_order_full_refund';
        ...
        public function preferences()
        {
            ...
            <div class="hook-instance">
                <h3><?php esc_html_e('Order Fully Refunded', 'mycred-toolkit'); ?></h3>
                <div class="row">
