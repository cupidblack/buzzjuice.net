...
function dzsvg_extras_featured_admin_init() {
  add_meta_box(DZSVG_ID.'_extras_featured_meta_options', esc_html__('DZS Video Gallery Settings'), 'dzsvg_extras_featured_admin_meta_options', 'post', 'normal', 'high');
  add_meta_box(DZSVG_ID.'_extras_featured_meta_options', esc_html__('DZS Video Gallery Settings'), 'dzsvg_extras_featured_admin_meta_options', 'page', 'normal', 'high');
}
