...
class phpVimeo
{
    const API_REST_URL = 'https://vimeo.com/api/rest/v2';
    const API_AUTH_URL = 'https://vimeo.com/oauth/authorize';
    const API_ACCESS_TOKEN_URL = 'https://vimeo.com/oauth/access_token';
    const API_REQUEST_TOKEN_URL = 'https://vimeo.com/oauth/request_token';
     ...
     * https://www.vimeo.com/api/docs/oauth
     *
